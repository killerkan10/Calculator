...
public class calculator extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int length = jTextField1.getText().length();  // get length
        int lastNum = jTextField1.getText().length()-1;  // get last number
        String holder;
        
        if (length > 0){
            StringBuilder backSpace = new StringBuilder(jTextField1.getText()); // create new string, delete last number from old string
            backSpace.deleteCharAt(lastNum);                                    // add new string to textfield 
            holder = backSpace.toString();
            jTextField1.setText(holder);
